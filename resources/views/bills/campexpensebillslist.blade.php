        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Camp Expense Bills</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Finance & Bills</a></li>
                                <li class="breadcrumb-item active">Camp Expense Bills</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="max-w-8xl mx-auto space-y-6">
                            <div class="p-3 sm:p-8 bg-white shadow sm:rounded-lg">
                                <div class="bg-white rounded-lg w-full">
                                    <!-- Title -->
                                    <h2 class="text-2xl font-semibold text-center mb-6">Camp Expense Bills
                                        Requests</h2>
...
document.addEventListener('input', function (e) {
    if (!e.target.classList.contains('amountInput')) return;

    const row = e.target.closest('.border');
    const billType = row.querySelector('.billTypeSelect').value;

    let max = null;

    if (billType === 'Inauguration') max = 1200;
    if (billType === 'Generator') max = 5000;

    if (max && Number(e.target.value) > max) {
        alert(`${billType} amount cannot exceed ₹${max}`);
        e.target.value = max;
    }
});
</script>
