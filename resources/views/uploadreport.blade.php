        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Report Upload</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#"></a>Report</li>
                                <li class="breadcrumb-item active">Report Upload</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                                <div class="bg-white p-8 rounded-lg w-full">
                                    ...
                                    <h2 class="text-2xl font-semibold text-center mb-6">Report Upload</h2>
                                    ...
                                    <!-- Upload Instruction -->
                                    <p class="text-center text-gray-600 mb-4">Upload PDF of the
                                        Camp Completion Report</p>
                                    ...
                                    <div id="dropZone"
                                        ...
                                        <p class="text-gray-500">Drag and drop PDF, or click to select</p>
