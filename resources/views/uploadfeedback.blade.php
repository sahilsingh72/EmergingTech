                            ...
                            <div class="p-3 sm:p-8 bg-white shadow sm:rounded-lg">
                                <div class="bg-white rounded-lg w-full">
                                    ...
                                    <form id="videoUploadForm" method="POST"
                                        action="{{ route('upload.videofeedback') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="space-y-5">
                                            ...
                                            <div id="videoDropZone"
                                                ...
                                                <input type="file" name="video_feedback" id="videoUpload" class="hidden"
                                                    accept="video/*">
                                                <!-- File Preview Section -->
                                                <div id="videoList"
                                                    class="mt-3 text-sm text-gray-700 flex flex-wrap gap-3">
                                                </div>
                                            </div>
