...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Institute Feedback</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Institute Feedback</a></li>
                    ...
                    <div class="max-w-8xl mx-auto space-y-6">
                        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                            <div class="bg-white rounded-lg w-full">
                                <h2 class="text-2xl font-semibold text-center mb-6">Upload Institute Feedback</h2>
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">

                                    <!-- Download PDF -->
                                    <a href="{{ asset('feedbackform/Institution Feedback Form.pdf') }}" target="_blank"
                                    ...
                                    <!-- Fill Online -->
                                    <a href="{{ route('institute.feedback.entry') }}"
                                    class="w-full sm:w-auto">
                                        <button
                                ...
                                <form id="instituteFeedbackUploadForm" action="{{ route('institute.feedback.store') }}" method="POST"
                                    ...
                                    <!-- Institute Feedback Upload -->
                                    <label class="block text-sm font-medium text-gray-700 mb-1 mt-3">
                                        Upload Institute Feedback (PDF or Image)<span style="color:red">*</span>
                                    </label>
                                    ...
                                    <div id="progressContainer" class="hidden mt-6">
                                        ...
                                        <p id="progressStatus" class="text-gray-600 text-sm mt-2 text-center italic">
                                            Preparing upload...</p>
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const form = document.getElementById('instituteFeedbackUploadForm');
            const overlay = document.getElementById('uploadOverlay');
            const progressContainer = document.getElementById('progressContainer');
            const progressBar = document.getElementById('progressBar');
            const progressStatus = document.getElementById('progressStatus');
            const feedbackInput = document.getElementById('fileUpload');
            ...
            form.addEventListener('submit', function (e) {
                ...
                xhr.open('POST', "{{ route('institute.feedback.store') }}", true);
                        ...
                        const finishTimer = setInterval(() => {
                            if (final < 100) {
                                ...
                                setTimeout(() => {
                                    ...
                                    document.getElementById('instituteFeedbackList').innerHTML = '';
                                }, 700);
                            }
                        }, 60);
                    } else {
        ...
        <script>
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "{{ route('institute.feedback.list') }}";
