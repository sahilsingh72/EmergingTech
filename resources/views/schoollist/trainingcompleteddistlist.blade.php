        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Training Completed Schools</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Training Completed Schools</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                            ...
                            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                                <div class="bg-white rounded-lg w-full">
                                    ...
                                    <div class="directory-header">
                                        <h1 class="text-3xl font-bold">Training Completed Schools</h1>
                                                ...
                                                <div class="col-md-4 mb-4 district-card-wrapper">
                                                    <div class="district-card">
                                                        ...
                                                        <div class="district-body">
                                                            ...
                                                            <a href="{{ route('school.training.completed.list', $dis->DSM_DSCD) }}"
...
$(document).ready(function () {
    ...
    @foreach($districts as $index => $d)
        $.get(`/school-{{ $d->DSM_DSCD }}-completed`, function (response) {

            const schools = response.schools;
            const previewBox = $("#school-preview-{{ $d->DSM_DSCD }}");
            ...
            schools.slice(0, 6).forEach(school => {
                previewHtml += `
                    <li style="color:green;font-weight:500;">
                        ${school.scm_name}
                    </li>`;
            });
            ...
            @foreach($districts as $d)
                $.get(`/school-{{ $d->DSM_DSCD }}-completed`, function (response) {
                    ...
                    schools.slice(0, 6).forEach(s => {
                        preview += `<li style="color:green;font-weight:500;">${s.scm_name}</li>`;
                    });
