        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Add Social Media</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Add Social Media</a></li>
                        ...
                        <div class="max-w-8xl mx-auto space-y-6">
                            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                                <div class="bg-white rounded-lg w-full">
                                    <h2 class="text-2xl font-semibold text-center mb-6">Add Social Media</h2>
                                    @if ($errors->any())
                                    ...
                                    <form action="{{ route('social.media.store') }}" method="POST" enctype="multipart/form-data"
                                        ...
                                        <!-- Post Type -->
                                        <div>
                                            <label class="block font-semibold mb-1">Social Media Platform</label>
                                        ...
                                        <!-- District -->
                                        <div>
                                            <label class="block font-semibold mb-1">District Name</label>
                                        ...
                                        <!-- Training Date -->
                                        <div>
                                            <label class="block font-semibold mb-1">Date of Training</label>
                                        ...
                                        <!-- media link -->
                                        <div>
                                            <label class="block font-semibold mb-1">Social Media Link (URL)</label>
                                            <input type="text" name="media_link" required
